...
export class GemBankClient extends AccountUtils {
  ...
  constructor(
    ...
    super(conn);
    // @ts-ignore
    this.wallet = wallet.adapter; //this.wallet.signTransaction is not a function
    this.setProvider();
  ...
  setProvider() {
    ...
    this.provider = new Provider(
      this.conn,
        // @ts-ignore
      this.wallet, //this.wallet.signTransaction is not a function
  ...
  async fetchAllGdrPDAs(vault?: PublicKey) {
    ...
    console.log(`found a total pdas`, pdas);
    return pdas;
  }
  ...
  async depositGem(
    ...
    console.log(
      `depositing vault ${vault}`
    );
    console.log(
      `depositing vaultAuthBump ${vaultAuthBump}`
    );
    console.log(
      `depositing GDRBump ${GDRBump}`
    );
    console.log(
      `depositing gemRarityBump ${gemRarityBump}`
    );
    console.log(
      `depositing gemRarity ${gemRarity}`
    );
    console.log(
